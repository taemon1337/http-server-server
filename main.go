...
func main() {
  ...
  flag.StringVar(&cfg.CAFile, "ca-file", cfg.CAFile, "The CA file path to use for CA")
  flag.StringVar(&cfg.CertFile, "cert-file", cfg.CertFile, "The cert file path to use for TLS server")
  flag.StringVar(&cfg.KeyFile, "key-file", cfg.KeyFile, "The cert key file path to use for TLS server")
  flag.StringVar(&cfg.CommonName, "servername", cfg.CommonName, "The common name and servername for TLS")
  flag.BoolVar(&cfg.SkipVerify, "skipverify", cfg.SkipVerify, "Skip TLS verification (does not apply to client auth)")
